...
class certification
{
     ...
     */
    public function set_details($fullname, $shortname, $category, $summary, $endnote, $idnumber, $visible)
    {
        global $DB, $USER;
    ...
    public static function get_categories()
    {
        global $DB;
        $categories = [];
        $resultcategories = $DB->get_records('course_categories', ['visible' => 1], 'sortorder ASC');
        foreach ($resultcategories as $categoryid => $category) {
    ...
    public static function copy($certifid)
    {
        ...
        $new->set_details($certification->fullname, $certification->shortname, $certification->category,
            $certification->summary, $certification->endnote, $certification->idnumber, 0, $certification->recertificationdatetype);
