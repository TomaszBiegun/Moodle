...
$string['visibleprogram'] = 'Visible';
$string['programidnumber'] = 'Certification ID number';
$string['programvisible'] = 'Certification visibility';
...
$string['individualcompletioncriteria'] = 'Enrolled as individual';
